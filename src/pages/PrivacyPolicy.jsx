  ...
  return (
    <PageTransition onBackToTop={handleBackToTop}>
      <div className="privacy-container">
        ...
        <p className="privacy-date">Last updated: March 03, 2025</p>
        <p>
        ...
        <ul>
          ...
          <li><strong>Company</strong>: (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Vindus Environment.</li>
