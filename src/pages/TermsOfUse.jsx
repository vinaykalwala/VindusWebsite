  ...
  return (
    <PageTransition onBackToTop={handleBackToTop}>
      <div className="terms-container">
        ...
        <p className="terms-date">Last updated: March 03, 2025</p>

        <p>Please read these terms and conditions carefully before using Our Service.</p>

        <h2 className="terms-subheading">Interpretation and Definitions</h2>
        ...
        <ul className="terms-list">
          ...
          <li><strong>Company</strong> (referred to as "the Company", "We", "Us" or "Our") refers to Vindus Environment.</li>
          <li><strong>Device</strong> means any device that can access the Service, such as a computer, cellphone, or tablet.</li>
          <li><strong>Service</strong> refers to the Website.</li>
          <li><strong>Website</strong> refers to Vindus Environment, accessible from <a href="https://www.vindusenvironment.com/">https://www.vindusenvironment.com/</a></li>
          <li><strong>You</strong> means the individual accessing or using the Service.</li>
        </ul>

        <h2 className="terms-subheading">Acknowledgment</h2>
        <p>
        ...
        <h2 className="terms-subheading">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
        <p>
        ...
        <h2 className="terms-subheading">Disputes Resolution</h2>
        <p>
          If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
        </p>

        <h2 className="terms-subheading">For European Union (EU) Users</h2>
        <p>
          If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
        </p>

        <h2 className="terms-subheading">United States Legal Compliance</h2>
        <p>
          You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
        </p>

        <h2 className="terms-subheading">Severability and Waiver</h2>
        <h2>Severability</h2>
        <p>
        ...
        <h2 className="terms-subheading">Translation Interpretation</h2>
        <p>
          These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.
        </p>

        <h2 className="terms-subheading">Changes to These Terms and Conditions</h2>
        <p>
        ...
        <ul className="terms-list">
          <li>
            By email: <a href="mailto:info.vindus@gmail.com?" className="contact-link">info.vindus@gmail.com</a>
          </li>
          <li>
            By visiting our website: <a href="https://www.vindusenvironment.com/" target="_blank" rel="noopener noreferrer" className="contact-link">Vindus Environment</a>
          </li>
          <li>
            By phone: <a href="tel:+914049525396" className="contact-link">+91 4049525396</a>
          </li>
        </ul>
      </div>
      <div className="terms-footer">
        <button onClick={handleBackToTop} className="back-to-top" title="Back to Top">
          <FaArrowUp />
        </button>
      </div>
    </PageTransition>
